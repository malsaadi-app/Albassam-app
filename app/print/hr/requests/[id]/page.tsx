...
import { getHRRequestPrintDoc } from '@/lib/print/hrRequest'

export default async function PrintHRRequestPage({
  params,
  searchParams
}: {
  ...
  const doc = await getHRRequestPrintDoc(id, locale, session.user.id)
  if (!doc) {
